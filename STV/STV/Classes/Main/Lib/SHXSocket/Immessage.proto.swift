...
final public class GiftMessage : GeneratedMessage {
    ...
    public static func == (lhs: GiftMessage, rhs: GiftMessage) -> Bool {
        ...
        fieldCheck = fieldCheck && (lhs.hasGiftGifUrl == rhs.hasGiftGifUrl) && (!lhs.hasGiftGifUrl || lhs.giftGifUrl == rhs.giftGifUrl)
        fieldCheck = (fieldCheck && (lhs.unknownFields == rhs.unknownFields))
        return fieldCheck
    }
    ...
    public fileprivate(set) var giftGifUrl:String! = nil
    public fileprivate(set) var hasGiftGifUrl:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        ...
        if hasGiftGifUrl {
            try codedOutputStream.writeString(fieldNumber: 5, value:giftGifUrl)
        }
        try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
        ...
        if hasGiftGifUrl {
            serialize_size += giftGifUrl.computeStringSize(fieldNumber: 5)
        }
        serialize_size += unknownFields.serializedSize()
        memoizedSerializedSize = serialize_size
        return serialize_size
    ...
    override public func getDescription(indent:String) throws -> String {
        ...
        if hasGiftGifUrl {
            output += "\(indent) giftGifUrl: \(giftGifUrl) \n"
        }
        output += unknownFields.getDescription(indent: indent)
        return output
    }
    override public var hashValue:Int {
        get {
            ...
            if hasGiftGifUrl {
                hashCode = (hashCode &* 31) &+ giftGifUrl.hashValue
            }
            hashCode = (hashCode &* 31) &+  unknownFields.hashValue
            return hashCode
        }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        public var giftGifUrl:String {
            get {
                return builderResult.giftGifUrl
            }
            set (value) {
                builderResult.hasGiftGifUrl = true
                builderResult.giftGifUrl = value
            }
        }
        public var hasGiftGifUrl:Bool {
            get {
                return builderResult.hasGiftGifUrl
            }
        }
        @discardableResult
        public func setGiftGifUrl(_ value:String) -> GiftMessage.Builder {
            self.giftGifUrl = value
            return self
        }
        @discardableResult
        public func clearGiftGifUrl() -> GiftMessage.Builder{
            builderResult.hasGiftGifUrl = false
            builderResult.giftGifUrl = nil
            return self
        }
        override public var internalGetResult:GeneratedMessage {
            get {
        ...
        public func mergeFrom(other:GiftMessage) throws -> GiftMessage.Builder {
            ...
            if other.hasGiftGifUrl {
                giftGifUrl = other.giftGifUrl
            }
            try merge(unknownField: other.unknownFields)
            return self
        }
        ...
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GiftMessage.Builder {
            ...
            while (true) {
                ...
                case 42:
                    giftGifUrl = try codedInputStream.readString()
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> GiftMessage.Builder {
            ...
            if let jsonValueGiftGifUrl = jsonMap["giftGifURL"] as? String {
                resultDecodedBuilder.giftGifUrl = jsonValueGiftGifUrl
            }
            return resultDecodedBuilder
        }
...
extension GiftMessage: GeneratedMessageProtocol {
    ...
    public subscript(key: String) -> Any? {
        ...
        case "giftGifUrl": return self.giftGifUrl
        default: return nil
        }
    }
}
    ...
    public subscript(key: String) -> Any? {
        ...
        set (newSubscriptValue) { 
            ...
            case "giftGifUrl":
                ...
                self.giftGifUrl = newSubscriptValue
            default: return
            }
        }
    }
